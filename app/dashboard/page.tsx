...
export default function Dashboard(){
  ...
  const [shop,setShop]=useState<any>({shopName:"MuhaAlifa Repairs", address:"", phone:"", footer:"", accent:"#0FB5C8", logo:null});
    ...
    <div className="min-h-screen flex flex-col bg-[#F5F7FB]">
      <div className="flex flex-1">
        <aside className="hidden md:flex w-[220px] flex-none bg-[#0B1220] text-white p-4 flex-col gap-1">
          <div className="text-white mb-6 px-2"><Brandmark logo={shop.logo}/></div>
        ...
        <div className="flex-1 flex flex-col min-w-0">
          <div className="h-[60px] flex-none border-b border-[#E3E8F1] bg-white flex items-center justify-between px-4 md:px-[30px]">
            <div className="font-bold text-[13.5px] text-[#66708A]">{shop.shopName}</div>
                ...
                return (
                  <div>
                    ...
                    <div className="grid lg:grid-cols-[1.3fr_1fr] gap-[22px] items-start">
                      ...
                      <div>
                        <PrintableTicket ticket={t} shop={shop}/>
